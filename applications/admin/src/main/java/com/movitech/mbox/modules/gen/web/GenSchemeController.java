 ...
 * 
 */
package com.movitech.mbox.modules.gen.web;
...
import com.movitech.mbox.modules.gen.service.GenSchemeService;
import com.movitech.mbox.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
    ...
    public String form(GenScheme genScheme, Model model) {
        if (StringUtils.isBlank(genScheme.getPackageName())){
            genScheme.setPackageName("com.movitech.mbox.modules");
        }
