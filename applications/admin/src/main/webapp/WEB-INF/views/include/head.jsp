...
<%@ page language="java" import="com.movitech.mbox.modules.cms.Constants" pageEncoding="utf-8"%>
<script type="text/javascript">
var ctx = '${ctx}', ctxStatic='${ctxStatic}',imgStatic='<%=Constants.file_show_url%>';</script>
