...
<body>
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/sys/role/"><%= PropertiesUtil.showGJH("角色列表")%></a></li>
        <li class="active"><a href="${ctx}/sys/role/form?id=${role.id}"><%= PropertiesUtil.showGJH("角色")%><shiro:hasPermission name="sys:role:edit">${not empty role.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit">查看</shiro:lacksPermission></a></li>
    </ul><br/>
    <form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
        <form:hidden path="id"/>
        <sys:message content="${message}"/>
        <div class="control-group">
            <label class="control-label"><%= PropertiesUtil.showGJH("角色名称:")%></label>
            <div class="controls">
        ...
        <div class="control-group">
         ...
         -->
        <div class="control-group">
            <label class="control-label"><%= PropertiesUtil.showGJH("角色授权:")%></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label"><%= PropertiesUtil.showGJH("备注:")%></label>
            <div class="controls">
